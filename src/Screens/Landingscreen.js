        ...
        <section className="transition-shadow bg-neutral-800">
          <div className="container p-8 mx-auto mt-20 mb-20 font-custom">
            <div className="grid grid-cols-3 gap-20 mt-20 mb-20">
              {/* services 1 and 2 */}
              <div className="grid justify-center grid-cols-1 gap-8 drop-shadow-2xl">
                <div
                ...
                >
                  ...
                  />
                  <h1 className="text-center mt-6 text-2xl font-semibold tracking-[1px] text-accent">
                    Room Cleaning
                  </h1>
                  <h1 className="mb-3 text-xl text-center text-slate-950">
                ...
                <div className="transition-shadow drop-shadow-2xl bg-zinc-100" data-aos="fade-right" data-aos-delay="200">
                  <img
                    ...
                    className="object-cover w-full h-[300px] transition delay-150 duration-300 ease-in-out"
                  />
                  <h1 className="justify-center items-center text-center mt-6 text-2xl font-semibold tracking-[1px] text-accent">
                    Drinks Included
                  </h1>
                  <h1 className="mb-3 text-xl text-center text-slate-950">
