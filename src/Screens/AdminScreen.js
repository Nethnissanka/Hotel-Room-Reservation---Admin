...
import backgroundImage2 from '../Screens/images/Background3.jpg'; 
...
function Adminscreen() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-center bg-cover backdrop-blur" 
    style={{ backgroundImage: `url(${backgroundImage2})` }}>
    <div className="container p-4 mx-auto mt-8 font-custom">
      <h2 className="m-2 text-5xl font-bold text-center text-white font-custom md-20">
        Admin Panel
      </h2>
      <Tabs
        defaultActiveKey="1"
        className="w-full mx-2 bg-gray-100 shadow-md font-custom"
      >
        <TabPane className="font-custom" tab="Bookings" key="1">
          <div className="mx-3 mb-3 font-custom row">
            <Bookings />
          </div>
        </TabPane>
        ...
        <TabPane tab="Users" key="4">
          <div className="mx-3 mb-3 font-custom row"><Users /></div>
...
export function Bookings() {
  ...
  return (
    <div className="col-md-12">
      <h1 className="text-3xl font-semibold text-center text-neutral-600 ">Bookings</h1>
      {loading ? (
        <Loader />
      ) : error ? (
        <Error />
        ...
        <div>
          <table className="w-full text-left bg-white rounded-md shadow-md table-auto">
            <thead className="text-white bg-neutral-600 bs">
              <tr>
  ...
  return (
    <div className="justify-center align-middle col-md-12">
      {loading ? (
        ...
        <div>
          <table className="w-full text-left bg-white rounded-md shadow-md table-auto text-neutral-600">
              ...
              {rooms.map((room) => (
                <tr key={room._id} className="border-b">
                  ...
                  <td className="px-4 py-2">
                    ...
                    <button
                      className="px-2 py-2 text-xs font-semibold text-white transition duration-300 bg-red-900 rounded-lg font-custom hover:bg-red-950 focus:outline-none focus:ring-2 focus:ring-yellow-600"
                  ...
                  <td className="px-4 py-2">
                    <button
                      className="px-2 py-2 text-xs font-semibold text-white transition duration-300 rounded-lg bg-accent hover:bg-accent-hover font-custom focus:outline-none focus:ring-2 focus:ring-yellow-600"
...
export function Addroom() {
  ...
  return (
    <div className="flex justify-center min-h-screen mb-10 bg-gray-50">
